...
=======================================================================================================
Script Purpose:
 This stored procedure loads data into 'bronze' schema fromexternal csv files.
...
BEGIN
  ...
  BEGIN TRY
    ...
    PRINT '>> Insert Data Into: bronze.erp_px_cat_g1v';
    BULK INSERT bronze.erp_px_cat_g1v
    FROM 'C:\sql\dwh_project\datasets\source_erp\px_cat_g1v.csv'
    WITH (
      FIRSTROW = 2,
      FIELDTERMINATOR = ','
      TABLOCK
